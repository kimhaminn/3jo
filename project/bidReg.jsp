    ...
    <div class="main">
      ...
      <form method="post" action="bidReg.jsp" id="regForm" onsubmit="return validateForm()">
        ...
        <div class="section-card">
          ...
          <div class="grid2">
            <div class="field"><label>부품명<span class="required">*</span></label><input type="text" id="partName" name="partName" placeholder="예: 알루미늄 하우징"></div>
            <div class="field"><label>부품코드<span class="required">*</span></label><input type="text" id="partCode" name="partCode" placeholder="예: AH-2026-001"></div>
            <div class="field">
            ...
            <div class="field"><label>재질<span class="required">*</span></label><input type="text" id="material" name="material" placeholder="예: 알루미늄 합금 A6061"></div>
            <div class="field"><label>규격<span class="required">*</span></label><input type="text" id="spec" name="spec" placeholder="예: 120mm x 80mm x 40mm"></div>
            <div class="field"><label>용도<span class="required">*</span></label><input type="text" id="usage" name="usage" placeholder="예: 엔진 보호 커버"></div>
            <div class="field"><label>특징<span class="required">*</span></label><input type="text" id="feature" name="feature" placeholder="예: 경량, 내열성 우수, CNC 가공"></div>
            <div class="field">
      ...
      <div class="section-card">
        ...
        <div style="overflow-x:auto;">
          <table class="tbl">
            <tr><th>#</th><th>부품명</th><th>코드</th><th>분류</th><th>재질</th><th>규격</th><th>용도</th><th>특징</th><th>사진</th><th>관리</th></tr>
            ...
            <tr>
              <td><%= i+1 %></td>
              <td><%= item.partName %></td>
              <td><span style="font-family:monospace;font-size:11px;color:var(--accent)"><%= item.partCode %></span></td>
              <td><span class="badge badge-blue"><%= item.partCategory %></span></td>
              <td><%= item.material %></td>
              <td><%= item.spec %></td>
              <td><%= item.usage %></td>
              <td><%= item.feature %></td>
              ...
              <td>
                ...
                <form method="post" style="margin:0;">
                  ...
                  <button type="submit" class="btn btn-danger" style="padding:4px 10px;font-size:11px;" onclick="return confirm('삭제할까요?')">삭제</button>
                </form>
