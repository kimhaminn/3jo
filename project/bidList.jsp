...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .empty-row td { text-align: center; color: var(--muted); padding: 40px; background: #0f2035 !important; font-size: 15px; cursor: default; }
        ...
        .part-name { color: #1e293b; text-decoration: none; font-size: 21px; }
        .part-name:hover { text-decoration: underline; color: #005b82; }
        .pn-badge { display: inline-block; font-size: 19px; background: rgba(0,61,165,.07); border: 1px solid rgba(0,100,200,.18); color: #1e4a80; border-radius: 5px; padding: 4px 14px; letter-spacing: 0.3px; font-family: 'Share Tech Mono', monospace; }

        .badge { display: inline-flex; align-items: center; justify-content: center; gap: 7px; width: 100px; padding: 6px 0; border-radius: 20px; font-size: 18px; font-weight: 600; white-space: nowrap; }
