...
<%
    ...
    if ("POST".equals(request.getMethod())) {
        ...
        try {
            ...
            if (vendorId == 0) {
                ...
                int price = 0;
                try { price = Integer.parseInt(unitPrice != null ? unitPrice.trim() : "0"); } catch(Exception ex){}
                ...
                psW.setInt(7, Integer.parseInt(bidId));
                psW.setInt(8, vendorId);
                psW.executeUpdate();
    ...
    try {
        ...
        if (vendorIdInt > 0) {
            ps = conn.prepareStatement(
                "SELECT quote_price, production_capacity, current_inventory, lead_time, moq, risk_grade " +
...
<div class="wrapper">
  ...
  <div class="layout">
    ...
    <div class="main">
      ...
      <!-- 2. 발주 부품 정보 (읽기 전용) -->
      <div class="section-card">
        <div class="section-title">2. 발주 부품 정보</div>
        <div class="info-grid">
          ...
          <div class="info-item"><div class="info-label">분류</div><div class="info-value"><%= partCategory %></div></div>
          <div class="info-item"><div class="info-label">재질</div><div class="info-value"><%= material %></div></div>
          <div class="info-item full"><div class="info-label">규격</div><div class="info-value"><%= spec %></div></div>
      ...
      <form method="post" action="bidItemReg.jsp?bidId=<%= bidId %>" id="regForm" onsubmit="return validateForm()">
        ...
        <div class="section-card">
          ...
          <div class="form-grid">
            <div class="field">
              <label>월 생산능력<span class="required">*</span></label>
            ...
            <div class="field">
              <label>현재 재고량<span class="required">*</span></label>
              <div class="input-unit">
            ...
            <div class="field full">
              <label>리드 타임<span class="required">*</span></label>
              <input type="text" id="lead_time" name="lead_time" value="<%= prevLeadTime %>" placeholder="예: 발주 후 영업일 기준 14일 이내">
              <div class="help">발주 후 납품까지 소요 기간을 입력하세요.</div>
            </div>
          </div>
        </div>
...
function validateForm() {
  var fields = ['production_capacity','current_inventory','lead_time','unit_price','moq'];
  var ok = true;
